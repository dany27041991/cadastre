...
Usage:
  From host (requires DATABASE_URL, DATA_DIR):
    python load_municipality_green_data.py [--municipality Lecce] [--data-dir PATH]
  In Docker (init image):
    python3 /scripts/database/seed/populate_municipality_data/load_municipality_green_data.py --municipality Lecce
...
def get_data_dir(municipality_name: str) -> Path:
    if "DATA_DIR" in os.environ:
        ...
        # Script is in infrastructure/scripts/database/seed/populate_municipality_data/
