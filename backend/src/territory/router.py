"""Territory composed FastAPI router (geo + areas + assets)."""
...
from territory.common.infrastructure.web.lakehouse_ctrl import router as lakehouse_router
...
router.include_router(lakehouse_router)
