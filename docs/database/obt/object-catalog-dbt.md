...
Per la **regola di copertura completa e senza sovrapposizioni** (e relativi vincoli GIS) si veda [Vincoli logici](../area/logical-constraints.md#3-catalogo-dbt-e-copertura-del-suolo).  
...
Per **regole e vincoli topologici** degli shapefile (conformità catalogo, posizionamento, sovrapposizioni, dimensioni, esoneri, oggetti semplici) si veda [Vincoli logici](../area/logical-constraints.md#4-shapefile-e-vincoli-topologici).
...
- Vincoli copertura e shapefile: [logical-constraints.md](../area/logical-constraints.md#3-catalogo-dbt-e-copertura-del-suolo) e [§4 Shapefile](../area/logical-constraints.md#4-shapefile-e-vincoli-topologici).
